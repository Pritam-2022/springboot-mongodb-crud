package net.springboot.demo.springbootmongodbcrud;
...
import net.springboot.demo.springbootmongodbcrud.SpringbootThymeleafWebAppApplication;
import net.springboot.demo.springbootmongodbcrud.entity.Employee;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = SpringbootThymeleafWebAppApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
